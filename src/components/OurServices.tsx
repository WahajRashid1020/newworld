...
const OurServices = () => {
  return (
    <section className="pt-28 pb-20 overflow-hidden bg-trueGray-400">
      <div className="container mx-auto px-10">
        <p className="mb-5 font-heading font-semibold text-s text-center uppercase tracking-px text-gray-200">
          THE SERVICES THAT MADE US SPECIAL
        </p>
        ...
        <div className="flex flex-wrap -m-4">
          <div className="w-full md:w-1/3 p-4">
            <div className="md:max-w-xs mx-auto text-center">
              <svg
                className="mx-auto mb-8 bg-pink-200"
                width="50"
                height="50"
                viewBox="0 0 50 50"
                fill="none"
              ...
              <p className="font-heading font-medium text-xl text-gray-900">
                Send us request form with all your event details
              </p>
            </div>
          </div>
          <div className="w-full md:w-1/3 p-4">
            <div className="md:max-w-xs mx-auto text-center">
              ...
              <p className="font-heading font-medium text-xl text-gray-900">
                Estimation is sent back with contract agreement
              </p>
            </div>
          </div>
          <div className="w-full md:w-1/3 p-4">
